...
This directory contains source files for the Albanian language
...
-   <https://giellalt.uit.no/lang/sqi/index.html> (analyser)
...
The Albanian language sources can be acquired using [giella SVN

...
function print_usage() {
    ...
    echo "  -l, --add-langvar   Add env. variable \$GTLANG_sqi to login script."
...
# the current dir:
if   test x${GTLANG_sqi} = x ; then
	echo "WARNING: The variable \${GTLANG_sqi} has not been defined. You"
	...
	echo "$0 -l"
	echo
elif test x${GTLANG_sqi} != x${LANGDIR} ; then
	echo "WARNING: The variable \${GTLANG_sqi} has the value:"
	echo "  ${GTLANG_sqi}"
